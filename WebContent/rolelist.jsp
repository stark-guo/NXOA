...
<div class="page-content">
    <form id="form1" name="form1" class="form-inline" action="saveRoleAndPermissions" method="post">
	...
	<div class="modal fade" id="editModal" tabindex="-1" role="dialog"
	  ...
	  <form id="permissionForm" name="permissionForm" action="saveSubmitPermission" method="post">
...
<script type="text/javascript">
	...
	function save(){
		...
		if(document.permissionForm.url.value==""||document.permissionForm.url.value==null){
			window.alert("链接地址不能为空!");
			return false;
		}
		if(document.permissionForm.percode.value==""||document.permissionForm.percode.value==null){
			window.alert("权限标识不能为空!");
			return false;
		}
		else{
