...
<div class="col-md-15" style="background-color: white;" id="show-refectory-html">
        ...
        <div class="panel panel-default">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
					...
					<tbody id="showBaoxiaoByPage"></tbody>
                    </tbody>
                </table>
...
function showRefectoryHtml(pageNum){
    $("#show-refectory-html").load("${pageContext.request.contextPath}/myBaoxiaoBill?pageNum="+pageNum);
}
</script>